...
app.get('/auth/verify', async (req, res) => {
  try {
    ...
    await supabase.from('users').update({ session_token: sessionToken }).eq('email', user.email);
    await saveUser(user);
    res.redirect('/dashboard.html?token=' + sessionToken + '&verified=true');
